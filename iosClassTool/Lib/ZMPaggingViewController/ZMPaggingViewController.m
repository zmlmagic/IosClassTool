...
#import "ZMPaggingViewController.h"
#import "ZMPNavigationBar.h"
...
@interface ZMPaggingViewController ()<UIScrollViewDelegate>
 ...
 *  显示title集合的容器
 */
@property (nonatomic, strong) ZMPNavigationBar *paggingNavbar;
...
@implementation ZMPaggingViewController
...
- (ZMPNavigationBar *)paggingNavbar {
    if (!_paggingNavbar) {
        _paggingNavbar = [[ZMPNavigationBar alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.bounds) / 2.0, 44)];
